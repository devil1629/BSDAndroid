...
public class quesfragments extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_fragment_factory);
    }
...
/*
    String frag;
    Q1Fragment fragment;
    Q3Fragment fragment3;
    int fragNum = 1;
    FragmentFactory fragfac;
    Button bt;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quesfragments);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        fragment = new Q1Fragment();

        fragment3 = new Q3Fragment();

        fragfac = new FragmentFactory();


        //bt = (Button) findViewById(R.id.Q2Next);

        getSupportFragmentManager()
                .beginTransaction()
                .add(R.id.quesframe,fragfac)
                .addToBackStack(null)
                .commit();
        ...
        bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                fragNum++;
                System.out.print("Number: " + fragNum );
    ...
    public void Next() {
        ...
        if(fragNum >=2 && fragNum< 3) {
            getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.quesframe, fragment3)
                    .addToBackStack(null)
                    .commit();
            // frag.setText("It is working");

        }
      if(fragNum >=3 && fragNum< 4) {
          bt.setVisibility(View.INVISIBLE);

            getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.quesframe, fragfac)
                    .addToBackStack(null)
                    .commit();
            // frag.setText("It is working");
